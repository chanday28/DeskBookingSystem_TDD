using DeskBooker.Core.DatabaseInterface;
...
namespace DeskBooker.Core.Processor
{
    public class DeskBookingRequestProcessorTest
    {
        ...
        [Fact]
        public void ShouldReturnDeskBookingRestWithRequestValues()
        {
            //Act
        ...
        [Fact]
        public void ShouldNotSavedDeskBookingIfDeskIsnotAvailable()
        {
