...
namespace DeskBooker.Web.Pages
{
    public class BookDeskModelTests
    {
        ...
        [Fact]
        public void ShouldAddModelErrorIfDeskAvailable()
        {
        ...
        public void ShouldReturenExpectedActionResult(Type expectedActionResultType, bool isModelValid,
            DeskBookingResultCode? deskBookingResultCode)
        {
            if(!isModelValid)
            {
                _bookDeskModel.ModelState.AddModelError("JustAKey", "AddErrorMessage");
            }
        ...
        public void ShouldRedirectToBookConfirmationPage()
        {
            ...
            _deskBookingResult.FirstName = "Alina";
            _deskBookingResult.LastName = "Huber";
            _deskBookingResult.Email = "alina.huber@gmail.com";
            _deskBookingResult.Date =new DateTime(2021,8,16);
